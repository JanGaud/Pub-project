          ...
          <div use:animateOnScroll class="flex w-full gap-2 border-b">
            <div class="flex flex-col justify-between w-full">
              ...
              <div class="flex gap-2 mt-2">
                {#if item.vegan}
                  <img src="static/dietaryTag/vegan.png" alt="Vegan" class="w-8 h-8" />
                {/if}
                {#if item.vegetarian}
                  <img src="static/dietaryTag/vegetarian.png" alt="Vegetarian" class="w-8 h-8" />
                {/if}
                {#if item.spicy}
                  <img src="static/dietaryTag/red-chili-pepper.png" alt="Spicy" class="w-8 h-8" />
                {/if}
              </div>
            </div>
          </div>
